              ...
              <div className=" hedeing max-w-[770px] z-20 md:mt-[300px] mt-[150px]  md:pl-[50px] md:pb-[40px] p-4 w-full ">
                <div className="md:p-5 md:bg-[#00000080] md:backdrop-blur-[100px] rounded-[16px]">
                  ...
                  <div className="flex gap-4 mt-2">
                    <div className="flex gap-3 text-[#F3F3F3] items-center">
                      <img alt="" src="/rating/1.png" />
                    ...
                    <div className="flex gap-3 text-[#F3F3F3] items-center">
                      <img alt="" src="/rating/2.png" />

                      <span>Wefanss</span>

                      <span>{item?.platformRating || 0}/10</span>
                    </div>
                  </div>

                  <p className="text-[#F5F5F5] text-[16px] mt-6">{item.notes}</p>
                  <div className="flex gap-4 mt-6 items-center">
                    <Link
                      ...
                      className="text-[#F3F3F3] primary-font font-[600] rounded-[4px] border flex items-center hover:curser-pointer justify-center w-fit border-[#D9D9D9] h-[48px] px-[16px]"
                    >
                      More Details
                    </Link>
                    <Link className="text-[#F3F3F3] bg-[#4285F4] gap-2 primary-font font-[600] rounded-[50px] border flex items-center justify-end w-fit border-[#4285F4] p-[4px] pl-[20px]">
                      Watch on{" "}
                      <svg
                        width="47"
                        height="45"
                ...
                <div className="md:p-5 md:bg-[#00000080] md:backdrop-blur-[100px] rounded-[16px]">
                  ...
                  <div className="flex gap-4 mt-2">
                    {selectedItem.rating.map((items, index) => (
                      <div
                        className="flex gap-3 text-[#F3F3F3] items-center"
                        key={index}
                      >
                        {" "}
                        <img src={items.img} alt="" />
                        <span>{items.site}</span>
                        <span>{items.per}/10</span>
                        {index !== selectedItem.rating.length - 1 && (
                          <svg
                            width="4"
                            height="4"
                            viewBox="0 0 4 4"
