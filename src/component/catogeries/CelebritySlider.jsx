      ...
      followStatus[item._id]
        ...
        : "bg-[#4285F4] text-white"
                      ...
                      <button
                        ...
                        className="px-4 h-[42px] hover:cursor-pointer  rounded-[24px] bg-white border border-[#4285F4] flex items-center"
                      >
                        <Share color="#4285F4" />
                      </button>
                        ...
                        <ul className="mt-5 flex flex-wrap gap-[10px]">
                          ...
                          <li className="group">
                            <Link className="flex flex-col transition-all duration-300 group-hover:bg-[#F4FBFF] p-2 w-full justify-between items-center">
                              ...
                              />
                              <h3 className="flex text-[8px] mt-[6px] gap-2 primary-font font-[500] items-center">
                                <span className="text-[#000]">X</span>
                              </h3>
                            </Link>
                          </li>
                          <li className="group">
                            <Link className="flex flex-col transition-all duration-300 group-hover:bg-[#F4FBFF] p-2 w-full justify-between items-center">
                              ...
                              />
                              <h3 className="flex text-[8px] mt-[6px] gap-2 primary-font font-[500] items-center">
                                <span className="text-[#000]">Linkedin</span>
                              </h3>
                            </Link>
                          </li>
                          <li className="group">
                          ...
                          <li className="group">
                            <Link className="flex flex-col transition-all duration-300 group-hover:bg-[#F4FBFF] p-2 w-full justify-between items-center">
                              ...
                              />
                              <h3 className="flex text-[8px] mt-[6px] gap-2 primary-font font-[500] items-center">
                                <span className="text-[#000]">Copy Link</span>
                              </h3>
                            </Link>
                          </li>
                        </ul>
