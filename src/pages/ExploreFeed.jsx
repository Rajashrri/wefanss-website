...
import { changePasswordApi } from "../utils/userloginApi";
  ...
  return (
    <div className="pb-[50px] slidebarboyfull sticky top-0 md:w-84 bg-white shadow p-[20px] rounded-[16px] flex flex-col">
      <div className="flex flex-col items-center">
        <div className="relative">
          <img
            ...
            className="rounded-full w-full h-[108px] overflow-hidden border border-[#34C759] border-[4px] p-1"
            alt=""
          />
          <h3 className="p-[10px] text-[#34C759] primary-font text-[14px] font-[500] px-3 m-auto absolute bottom-[-15px] left-[28%] bg-[#F3FFF6] w-fit rounded-[8px]">
            80%
          </h3>
        </div>
        <div className="mt-6  md:flex hidden justify-center">
          <h3 className="berlin text-[20px]">  {profile?.name || "User"}</h3>
        </div>
      </div>
      ...
      <div className="mt-6 flex sidemulink md:flex-col space-y-2 flex-1 overflow-auto">
        ...
        >
          <svg
            className="me-[10px] group-hover:fill-white"
...
const FeedCard = () => {
  return (
    <div className="rounded-xl p-4 ">
      <p className="primary-font text-[#868484] text-[12px]">
        Interview · 02-01-2026
      </p>
      ...
      <img src={img12} alt="" className="rounded-lg my-[16px] w-full" />
      ...
      <ul className="mt-[16px] flex gap-[10px] flex-wrap">
        <li>
          <a
            href="#!"
            className="px-[16px] py-[8px] text-[14px] bg-[#4285F41F] primary-font text-[#4285F4] rounded-[100px]"
          >
            Jaya Bachchan
          </a>
        </li>
...
const Trending = () => {
  return (
    <div className="rounded-xl p-4 bg-[#fff]">
      <h3 className="font-semibold text-[20px] flex items-center berlin mb-2">
        <svg
          className="me-3"
          xmlns="http://www.w3.org/2000/svg"
          width="12"
        ...
        >
          <path
            d="M12 6.92822L0 13.8564L0 1.95503e-05L12 6.92822Z"
            fill="#4285F4"
          />
        </svg>
        Trending Trivia
      ...
      <a
        href=""
        className="text-[#4285F4] text-[14px] font-[600] mt-[36px] text-center block cursor-pointer"
      >
        see more
      </a>
    </div>
...
const fetchProfile = async () => {
            ...
            <div className="max-w-[762px] m-auto bg-[#fff] p-[24px] rounded-[16px]">
              <div className="p-[16px] bg-[#F4FBFF] rounded-[8px] mb-[14px]">
                ...
                <input
                  ...
                  className="bg-[#F5F5F5] w-full p-[16px] rounded-[8px] outline-none focus:ring-none focus:ring-none"
                  placeholder="Name"
                />
  ...
  <img
    ...
    alt="profile"
    className="w-[100px] h-[100px] rounded-full object-cover mb-3 border"
  />
  ...
  />
              ...
              <div className="mt-[26px] flex justify-end gap-[10px]">
                <button className="py-[12px] px-[24px] rounded-[8px] font-[600] bg-[#F5F5F5] text-[#1E1E1E] dm-sans font-[16px]">
                  Close
                </button>
                <button
                  onClick={handleUpdate}
                  className="py-[12px] px-[24px] rounded-[8px] font-[600] bg-[#4285F4] text-[#fff] dm-sans font-[16px]"
                >
                  Edit
                </button>
              </div>
        ...
        const formattedData = response.data.data.map((item) => ({
          ...
          link: (() => {
            ...
            // both
              ...
              profileLink = `/profiles/${item?.identityProfile?.slug || ""}`;
            }

            return profileLink;
          })(),

          cardcalss: "lg:col-span-1 md:col-span-2 sm:col-span-3 col-span-6",
        }));
...
export function MyCollections() {
  ...
  return (
    <>
      ...
      <div>
        <ul className="flex gap-2 px-6 py-2 bg-[#4285F4]">
          <li className="text-[#fff] text-[12px]">Home</li>
          <li className="text-[#fff] text-[12px]">/</li>
          <li className="text-[#fff] text-[12px]">My Collections</li>
        </ul>
      </div>
...
export function CollectionsDetails() {
  ...
  const fetchCollectionDetails = async () => {
    try {
      const response = await getCollectionDetails(slug);
      ...
      if (response?.data?.success) {
        ...
        setActorsData(formattedCelebrities);
      }
    } catch (error) {
      console.log(error);
    }
    ...
    <>
      ...
      <div>
        <ul className="flex gap-2 px-6 py-2 bg-[#4285F4]">
          ...
          <li className="text-[#fff] text-[12px]">Change Password</li>
        </ul>
      </div>
