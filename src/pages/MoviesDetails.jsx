                ...
                >
                  ...
                  >
                    <g clip-path="url(#clip0_1460_3563)">
                      <path
                        d="M18.1992 12.4H1.79922C1.59922 12.4 1.39922 12.4 1.19922 12.3V19.4C1.19922 19.7 1.49922 20 1.79922 20H18.0992C18.3992 20 18.6992 19.7 18.6992 19.4V12.3C18.5992 12.4 18.3992 12.4 18.1992 12.4Z"
                        fill={`${context.Contenttype === "Elections" ? "#fff" : "#000"}`}
                      />
                      <path
                        d="M1.79922 11.2H18.0992C18.4992 11.2 18.7992 10.8 18.6992 10.5L17.3992 5.5C17.3992 5.2 17.1992 5 16.8992 5H15.5992V7.5C16.3992 7.5 16.3992 8.6 15.5992 8.7H4.39922C3.59922 8.7 3.59922 7.6 4.39922 7.5V5H3.09922C2.79922 5 2.59922 5.2 2.49922 5.5L1.19922 10.5C1.19922 10.7 1.19922 10.9 1.29922 11C1.49922 11.1 1.69922 11.2 1.79922 11.2Z"
                        fill={`${context.Contenttype === "Elections" ? "#fff" : "#000"}`}
                      />
                      <path
                        d="M14.3977 0.6C14.3977 0.3 14.0977 0 13.7977 0H6.19766C5.89766 0 5.59766 0.3 5.59766 0.6V7.5H14.3977V0.6ZM12.2977 2.9L9.79766 5.4C9.59766 5.7 9.19766 5.7 8.99766 5.4L7.69766 4.2C7.49766 4 7.49766 3.6 7.69766 3.4C7.89766 3.2 8.29766 3.2 8.49766 3.4L9.29766 4.2L11.3977 2.1C11.5977 1.9 11.9977 1.9 12.1977 2.1C12.4977 2.3 12.4977 2.7 12.2977 2.9Z"
                        fill={`${context.Contenttype === "Elections" ? "#fff" : "#000"}`}
                      />
                    </g>
                    <defs>
                ...
                >
                  ...
                  >
                    <g clip-path="url(#clip0_1460_3539)">
                      <path
                        d="M15.5 10.8V11.8H13.9V10.7C13.9 10.4 13.6 10.1 13.3 10.1C13 10.1 12.7 10.4 12.7 10.7V11.8H7.2V10.7C7.2 10.4 6.9 10.1 6.6 10.1C6.3 10.1 6 10.4 6 10.7V11.8H4.5V10.8C4.5 9.29998 5.4 8.09998 6.7 7.59998C6.8 7.69998 6.8 7.79998 6.9 7.79998C7.6 8.59998 8.5 8.99998 9.4 9.09998V9.99998C9.4 10.3 9.7 10.6 10 10.6C10.3 10.6 10.6 10.3 10.6 9.99998V9.09998C11.5 8.99998 12.4 8.49998 13.1 7.89998C13.2 7.79998 13.3 7.69998 13.3 7.69998C14.6 8.09998 15.5 9.39998 15.5 10.8Z"
                        fill={`${context.Contenttype === "PositionsHeld" ? "#fff" : "#000"}`}
                      />
                      <path
                        d="M17.1992 17.3L16.7992 19.5C16.7992 19.8 16.4992 20 16.1992 20H3.69922C3.39922 20 3.19922 19.8 3.09922 19.5L2.69922 17.3H17.1992Z"
                        fill={`${context.Contenttype === "PositionsHeld" ? "#fff" : "#000"}`}
                      />
                      <path
                        d="M17.9016 8.99998V11.9H16.7016V8.99998C16.7016 8.39998 16.5016 7.79998 16.0016 7.29998L15.0016 6.29998C14.8016 6.09998 14.8016 5.69998 15.0016 5.49998C15.2016 5.29998 15.6016 5.29998 15.8016 5.49998L16.8016 6.49998C17.5016 7.19998 17.9016 8.09998 17.9016 8.99998Z"
                        fill={`${context.Contenttype === "PositionsHeld" ? "#fff" : "#000"}`}
                      />
                      <path
                        d="M5.00156 6.29995L4.00156 7.29995C3.60156 7.79995 3.30156 8.39995 3.30156 9.09995V11.9H2.10156V9.09995C2.10156 8.09995 2.50156 7.29995 3.10156 6.59995L4.10156 5.59995C4.30156 5.39995 4.70156 5.39995 4.90156 5.59995C5.30156 5.69995 5.30156 6.09995 5.00156 6.29995Z"
                        fill={`${context.Contenttype === "PositionsHeld" ? "#fff" : "#000"}`}
                      />
                      <path
                        d="M18.6008 13H1.40078C1.10078 13 0.800781 13.3 0.800781 13.6V15.5C0.800781 15.8 1.10078 16.1 1.40078 16.1H18.5008C18.8008 16.1 19.1008 15.8 19.1008 15.5V13.6C19.2008 13.3 18.9008 13 18.6008 13Z"
                        fill={`${context.Contenttype === "PositionsHeld" ? "#fff" : "#000"}`}
                      />
                      <path
                        d="M7.40234 2.8H6.90234C7.10234 1.2 8.40234 0 10.0023 0C10.9023 0 11.7023 0.4 12.2023 0.9C12.7023 1.4 13.0023 2.1 13.1023 2.8H12.7023C11.4023 2.8 11.0023 2 11.0023 2C10.9023 1.8 10.7023 1.6 10.5023 1.6C10.2023 1.7 10.0023 1.8 9.90234 2C9.80234 2.1 9.30234 3 7.40234 2.8Z"
                        fill={`${context.Contenttype === "PositionsHeld" ? "#fff" : "#000"}`}
                      />
                      <path
                        d="M13.1023 3.99995V4.79995C13.1023 6.59995 11.7023 7.99995 10.0023 7.99995C8.30234 7.99995 6.90234 6.59995 6.90234 4.79995V3.99995H7.30234C9.00234 4.19995 9.90234 3.69995 10.4023 3.19995C10.8023 3.59995 11.6023 3.99995 12.7023 3.99995H13.1023Z"
                        fill={`${context.Contenttype === "PositionsHeld" ? "#fff" : "#000"}`}
                      />
                    </g>
                    <defs>
