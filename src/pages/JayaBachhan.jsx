...
export default function JayaBachhan() {
  ...
  const sidebarData = [
...

    {
      ...
      items: electionItems.slice(0, 3).map((item, index) => ({
        ...
        tag: [item.election_year || "N/A", item.party || item.type || "N/A"],

        // won/lost handling
        status:
          item.result && item.result.toLowerCase() === "won"
            ? true
            : item.result && item.result.toLowerCase() === "lost"
              ? false
              : null,
  ...
  return (
    <MyContext.Provider value={{ active, setActive }}>
      ...
      >
        <div
          className={` gap-4 px-2 ${active ? "boxvtive" : "smallxod grid grid-cols-12"}`}
        >
          ...
          <div className="md:col-span-3 leftbox col-span-12 md:px-[10px] px-[10px] py-[20px] h-fit rounded-[8px] space-y-4 bg-[#fff]">
                  ...
                  >
                    <div className="overflow-hidden">
                      ...
                      {section.type !== "profile" && (
                        <a
                          href={section.link}
                          className="text-[#4285F4] block text-[14px] text-center font-primary font-[700] mt-2 cursor-pointer hover:underline"
                        >
                          see more
                        </a>
                      )}
            ...
            <div className="bg-[#F4FBFF] rounded-[8px] p-4 transition-all duration-300 flex">
              <p className="text-[16px] primary-font font-[500] pr-1">
                Lorem ipsum dolor sit amet consectetur. lectus integer mattis id
              </p>
              <div className="bg-[#4285F4] gap-1 rounded-[4px] w-[180px] flex justify-center items-center flex-col ">
                <svg
                  width="33"
                  height="32"
                  viewBox="0 0 33 32"
          ...
          {/* CENTER CONTENT */}
          <div
            className={`${active ? "max-w-[70%] m-auto" : "md:col-span-6 col-span-12"} md:px-2 px-0 space-y-6`}
          >
            ...
            <div className="md:px-[20px] px-[10px] py-[20px] rounded-[8px] space-y-4 bg-[#fff]">
              <div>
                <h3 className="flex gap-2 items-center berlin text-[#1E1E1E] md:text-[24px] text-[20px] text-[400]">
                  ...
                  >
                    <path
                      d="M10.5 6.06226L0 12.1244V7.82013e-05L10.5 6.06226Z"
                      fill="#4285F4"
                    />
                  </svg>
                ...
                <p className="mt-1 primary-font text-[16px] text-[#1E1E1E] font-[400]">
                  During late 90s, Kumar was in a relationship with actress
                  Raveena Tandon. Although they were engaged, they later parted
                  ways.[301][302] Later from 1997 to 2000, Kumar was in a
                  relationship with actress Shilpa Shetty.[303]
                </p>
                <p className="mt-1 primary-font text-[16px] text-[#1E1E1E] font-[400]">
                  Kumar met actress Twinkle Khanna, the daughter of actors
                  Rajesh Khanna and Dimple Kapadia, during a photo session for
                  Filmfare magazine.[304] Kumar married Khanna on 17 January
                  2001. Together have a son (Aarav, born 2002) and a daughter
                  (Nitara, born 2012).[305][306] He is known as a protective
                  father and keeps his children away from the media. He stated
                  that he wants to "give them a normal childhood."[307] Kumar
                  often credits Khanna for his success.[308][309]
                </p>
                <p className="mt-1 primary-font text-[16px] text-[#1E1E1E] font-[400]">
                  In 2009, while performing at a show for Levis at Lakme Fashion
                  Week, Kumar asked Twinkle to unbutton his jeans. This incident
                  sparked a controversy which led to a police case being filed
                  against them.[310]
                </p>
                <hr className="my-4 text-[#4285F429]" />
              </div>
              <div>
                <h3 className="flex gap-2 mb-3 items-center berlin text-[#1E1E1E] md:text-[24px] text-[20px] text-[400]">
                  <svg
                    width="11"
                    height="13"
                    viewBox="0 0 11 13"
                ...
                <p className="mt-1 primary-font text-[16px] text-[#1E1E1E] font-[400]">
                  Kumar was initially religious, till 2017 being a practising
                  Shaiva Hindu who regularly visited shrines and temples across
                  the country, including the famed Vaishno Devi
                  Mandir,[311][312][313][294] while in 2018 he said "there is
                  only one God" and was against bringing religion into
                  politics,[314] but in March 2020 he stated, "I don't believe
                  in any religion. I only believe in being Indian".[315]
                </p>
                <hr className="my-4 text-[#4285F429]" />
              </div>
              <div>
                <h3 className="flex gap-2 mb-3 items-center berlin text-[#1E1E1E] md:md:text-[24px]  text-[20px] text-[400]">
                  <svg
                    width="11"
                    height="13"
                    viewBox="0 0 11 13"
              ...
              <div>
                ...
                <h4 className="primary-font text-[18px] text-[#1E1E1E] font-[500] pb-2">
                  Television
                </h4>
                <ul className="pl-5">
                  <li className="mt-1 primary-font text-[16px] text-[#1E1E1E] font-[400] list-disc">
                    In 2004, Kumar presented seven-part miniseries Seven Deadly
                    Arts with Jaya Bachchan for free,[276] played master and
                    learner as he introduces viewers to each of the seven part
                    of martial arts-kalaripayattu, Shaolin Kung Fu, karate,
                    taekwondo, aikido, Muay Thai, capoeira,[277] the show aired
                    on every following Sunday.[278] The following subtitle Kumar
                    was awarded the highest Japanese honour of "Katana" and a
                    sixth degree black belt in Kuyukai Gōjū-ryū karate.
                  </li>
                  <li className="mt-1 primary-font text-[16px] text-[#1E1E1E] font-[400] list-disc">
                    Since 2008, Kumar started India's stunt/action reality game
                    show – "Fear Factor: Khatron Ke Khiladi". He hosted Season
                    1, Season 2 and Season 4.[279] The show was widely accepted
                    and appreciated, became hugely successful in popular
                    culture.[280] It is still being run by Rohit Shetty.
                  </li>
                </ul>
              ...
              <div>
                ...
                <ul className="pl-5">
                  <li className="mt-1 primary-font text-[16px] text-[#1E1E1E] font-[400] list-disc">
                    Kumar promotes health fitness and exercising, stays in shape
                    with a combination of kickboxing, basketball, swimming and
                    Parkour as well as working out. While in standard eighth he
                    had started practising Karate. He intended to open a martial
                    arts school and the state government of Maharashtra allotted
                    land for the school in Bhayandar.[291]
                  </li>
                  <li className="mt-1 primary-font text-[16px] text-[#1E1E1E] font-[400] list-disc">
                    He helped Khanna with editing the drafts of her debut book
                    Mrs Funnybones.[292] He is a teetotaller[293] but has
                    endorsed for a liquor brand in the past. Half of the sum was
                    given for daan (charity work), of which he has been doing
                    more of in recent times.
                  </li>
                  <li className="mt-1 primary-font text-[16px] text-[#1E1E1E] font-[400] list-disc">
                    On 9 August 2014, Kumar performed at his 500th live show.
                    The show was held in O2 Arena in London as part of the
                    inaugural function of the World Kabaddi League. His first
                    live show was held in 1991 in Delhi. Kumar owns Bengal
                    Warriors a team in the Indian Kabbadi League.[291][299] Jaya
                    Bachchan sets himself on fire at his upcoming The End series
                    launch with Prime Video, says he's a stuntman first and
                    actor later.[300]
                  </li>
                </ul>
                ...
                <div className="grid gap-[20px] grid-cols-4">
                  {grid.map((item) => (
                    <div id={item.id} className="col-span-1">
                      ...
                      <h3 className="mt-1 primary-font text-[16px] text-[#1E1E1E]">
                        {item.disk}
                      </h3>
                    </div>
                  ))}
                    ...
                    <div id={item.id} className="col-span-4 flex gap-3">
                      <figure>
                        <img
                          src={item.img}
                          alt=""
                          className="w-[100px] h-[100px] border border-1 border-[#00000040] rounded-[4px]"
                        />
                      </figure>
                      <div>
                        <h3 className="mt-1 primary-font text-[#1E1E1E] font-[500]">
                          {item.name}
                        </h3>
                        <p className="mt-1 text-[14px] primary-font text-[#757575]">
                          {item.disk}
                        </p>
                      </div>
                    </div>
